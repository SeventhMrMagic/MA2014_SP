...
Las RBM permitieron representar estas relaciones dentro de un modelo 
...
Sin embargo, los resultados deben interpretarse como relaciones probabilísticas 
...
El análisis mediante RBM permitió identificar relaciones relevantes 
entre características geográficas, educativas y de uso del transporte con la 
percepción de su rapidez y eficiencia. Entre los principales hallazgos, las localidades 
clasificadas como rurales presentaron una mayor probabilidad de percibir favorablemente 
la rapidez del transporte; las personas con escolaridad básica mostraron una mejor 
percepción de eficiencia que aquellas con escolaridad alta; y los usuarios habituales 
del transporte presentaron una percepción considerablemente más favorable de su 
eficiencia que los no usuarios. En contraste, la relación entre condición física y 
uso cotidiano del automóvil no pudo establecerse con suficiente confianza debido al 
tamaño limitado de la muestra disponible para este grupo.

Estos resultados muestran la utilidad de la RBM para estudiar las relaciones entre 
múltiples variables categóricas asociadas con la 
movilidad en México y generar evidencia potencialmente útil para la planificación 
urbana. Sin embargo, al tratarse de datos observacionales, los resultados deben interpretarse como asociaciones 
y no como relaciones causales. Como trabajo futuro, se propone ampliar el tamaño de la 
muestra, incorporar nuevas variables relacionadas con accesibilidad, seguridad y 
características geográficas, y validar los modelos con nuevas bases de datos que 
permitan obtener estimaciones estadísticamente más significantes.
